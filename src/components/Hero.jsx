...
import { FaGithub, FaLinkedin, FaFacebook, FaTelegram   } from "react-icons/fa6";
    ...
    <div className="pt-20 sm:pt-40">
      <div className='container flex flex-col sm:flex-row pt-10 px-5 sm:px-0'>
        ...
        <div className='flex flex-1 items-center justify-center sm:justify-end order-1 sm:order-2'>
            <img src="images/hero1.png" alt="GradPic" className="w-70 sm:w-110 dark:hidden rounded-4xl " data-aos="fade-left"/>
            <img src="images/hero2.png" alt="GradPic" className="w-70 sm:w-110 hidden dark:block rounded-4xl " data-aos="fade-left"/>
        </div>
      </div>
    </div>
    </>
